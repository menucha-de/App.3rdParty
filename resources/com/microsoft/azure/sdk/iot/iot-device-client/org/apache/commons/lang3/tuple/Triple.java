...
public abstract class Triple<L, M, R> implements Comparable<Triple<L, M, R>>, Serializable {
    ...
    public int compareTo(final Triple<L, M, R> other) {
		...
		if (getLeft() == other.getLeft())
			...
			result = 1;
		else if (getLeft() instanceof Comparable) {
			@SuppressWarnings("unchecked")
			Comparable<Object> left = ((Comparable<Object>) getLeft());
			result = left.compareTo(other.getLeft());
		}
		if (result == 0) {
			if (getMiddle() == other.getMiddle())
				result = 0;
			else if (getMiddle() == null)
				result = -1;
			else if (other.getMiddle() == null)
				result = 1;
			else if (getMiddle() instanceof Comparable) {
				@SuppressWarnings("unchecked")
				Comparable<Object> middle = ((Comparable<Object>) getMiddle());
				result = middle.compareTo(other.getMiddle());
			}
		}
		if (result == 0) {
			if (getRight() == other.getRight())
				...
				result = 1;
			else if (getRight() instanceof Comparable) {
				@SuppressWarnings("unchecked")
				Comparable<Object> right = ((Comparable<Object>) getRight());
				result = right.compareTo(other.getRight());
			}
		}
		return result;
    }
